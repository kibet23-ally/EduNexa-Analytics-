...
// Keep your Supabase queries.
// Keep your report calculations.
  ...
  return (
    <div className="bg-slate-100 min-h-screen p-4 md:p-8">
      ...
      <div className="flex justify-end mb-4 no-print">
        <button
          onClick={handlePrint}
          className="flex items-center gap-2 bg-blue-950 hover:bg-blue-900 text-white px-5 py-2 rounded-xl transition-all"
        >
        ...
        <div className="bg-white px-6 pt-6">
          ...
          <div className="border rounded-3xl p-6 grid md:grid-cols-3 gap-6 shadow-sm mb-8">
            ...
            <InfoCard
              ...
              value={`${student?.rank} out of ${totalStudents}`}
            />
          </div>
