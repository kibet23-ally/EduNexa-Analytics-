...
import { PDF_TABLE_THEME, PDF_COLORS, PDF_CONTENT_X, addBorderToAllPages, addPdfFooter } from '../lib/pdfKit';
...
async function generatePDF(params: {
  ...
  // Border on every page, then footer/page numbers — added last, after
  // autoTable has finished creating any extra pages for long class lists.
